    ...
    def test_runs_report(self, mocked_datetime, mocked_cfg):
        ...
        mocked_cfg.assert_any_call(
            ...
            ajax_call={
                ...
                'merge_on': 'run_id',
                'api_urls': ['/api/0.1/aggregate/all_runs', '/api/0.1/lims/status/run_status']
            },
        ...
        mocked_cfg.assert_any_call(
            ...
            ajax_call={
                ...
                'merge_on': 'run_id',
                'api_urls': [
                    '/api/0.1/aggregate/all_runs?match={"_created": {"$gte": "12_11_2017_00:00:00"}}',
                    '/api/0.1/lims/status/run_status?createddate=12_11_2017_00:00:00'
                ]
            },
            create_row='color_filter',
            fixed_header=True,
        ...
        mocked_cfg.assert_any_call(
            ...
            ajax_call={
                ...
                'merge_on': 'run_id',
                'api_urls': [
                    '/api/0.1/aggregate/all_runs?match={"_created": {"$gte": "12_12_2016_00:00:00"}}',
                    '/api/0.1/lims/status/run_status?createddate=12_12_2016_00:00:00'
                ]
            },
            create_row='color_filter',
            fixed_header=True,
        ...
        mocked_cfg.assert_any_call(
            ...
            ajax_call={
                ...
                'merge_on': 'run_id',
                'api_urls': [
                    '/api/0.1/aggregate/all_runs?match={"_created": {"$gte": "01_01_2017_00:00:00"}}',
                    '/api/0.1/lims/status/run_status?createddate=01_01_2017_00:00:00'
                ]
            },
            create_row='color_filter',
            fixed_header=True,
    ...
    def test_report_samples(self, mocked_datetime, mocked_cfg):
        ...
        mocked_cfg.assert_called_with(
            ...
            ajax_call={
                ...
                'merge_on': 'sample_id',
                'api_urls': [
                    '/api/0.1/aggregate/samples',
                    '/api/0.1/lims/status/sample_status',
                    '/api/0.1/lims/samples'
                ]
            },
