...
from rest_api.limsdb.queries.factories import _create_samples, sample_status, sample_status_per_project, \
    sample_status_per_plate
...
mocked_retrieve_args = patch('rest_api.limsdb.queries.factories.retrieve_args',
                             return_value={'match': {'sample_id': 'X99999P001H05', 'project_id': 'X99999'}})
mocked_get_project_info = patch('rest_api.limsdb.queries.get_project_info', return_value=[
    ('X99999', datetime(2016, 9, 1, 13, 0), None, 'Jane', 'Doe', 'Number of Quoted Samples', '2')])
...
mocked_get_samples_and_processes = patch(
    ...
    return_value=[
        ('X99999', 'X99999P001H05', 'Receive Sample EG 6.1', 'COMPLETE', datetime(2016, 11, 11, 11, 45, 3, 367000),
         39005),
        ('X99999', 'X99999P001H05', 'Sequencing Plate Preparation EG 2.0', 'COMPLETE',
         datetime(2016, 11, 23, 13, 34, 50, 491000), 39917),
...
class SampleTest(TestCase):
    ...
    def test_all_statuses(self):
        ...
        self.sample1.add_queue_location('Sequencing Plate Preparation EG 2.0',
                                        datetime.strptime('20-07-15', '%d-%m-%y'), queue_id=111)
        all_status = self.sample1.all_statuses()
...
class ContainerTest(TestCase):
    ...
    def test_samples_per_status(self):
        ...
        self.sample2.add_completed_process('Sequencing Plate Preparation EG 2.0',
                                           datetime.strptime('20-07-15', '%d-%m-%y'), process_id=111)
        samples_per_status = self.container1.samples_per_status()
